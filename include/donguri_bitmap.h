...
// 'donguri', 128x47px
// Separated from ESP32_SpeedMeter.cpp to keep the source tidy.
// Internal linkage via 'static' avoids multiple definition if included elsewhere.
static const unsigned char epd_bitmap_donguri[] PROGMEM = {
